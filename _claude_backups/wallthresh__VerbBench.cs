...
public class VerbBench : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        yield return AimWallAt(90f);                       // escape ABEAM
        {
            ...
            Disarm();
            Check(q1 > q0 + 0.5f, "a 0.8 s AWAY burst clears ground with the escape ABEAM ("
        ...
        yield return new WaitForSeconds(6.0f);
        {
            ...
            float worst = 0f;
            for (int i = 0; i < 150; i++)                    // the last 3 s
            { yield return new WaitForFixedUpdate(); worst = Mathf.Max(worst, MaxCmd()); }
            ...
            Check(crept < 0.30f, "...and stays put (" + F(crept) + " m of creep)");
        }
